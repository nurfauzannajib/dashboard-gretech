...
import RealtimeChart from "../../charts/RealtimeChartco";
...
function DashboardCard05() {
  ...
  const data = [500.81, 500.75, 501.48, 501.21, 499.67, 499.8, 500.32, 500.56];
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white shadow-lg rounded-sm border border-gray-200">
      <header className="px-5 py-4 border-b border-gray-100 flex items-center">
        <h2 className="font-semibold text-gray-800">Co2</h2>
        <Info className="ml-2" containerClassName="min-w-44">
          <div className="text-sm text-center">Kadar Co2</div>
        </Info>
      </header>

...
function Summary() {
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-green-400 shadow-lg rounded-sm border border-gray-200 -mb-6">
      <header className="px-8 py-4 border-b border-gray-100 flex items-center justify-between">
        <div className="h-16 w-16 rounded-md shadow-2xl bg-white flex">
          <p className="flex items-center pl-4 font-bold text-md">null</p>
        </div>
